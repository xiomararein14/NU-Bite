...
const gcashNumber = "09686914342 MDM";
...
function showPaymentDetails() {
  ...
  if (method === "Cash on Pickup") {
    box.innerHTML = `<p>Please pay at the canteen counter when you pick up your order.</p>`;
  }

  if (method === "GCash QR Code") {
    box.innerHTML = `
      <h3>Scan GCash QR Code</h3>
      <img src="../images/instapay-qr.jpg" alt="GCash QR Code" onerror="this.style.display='none'">
      <p>After payment, click Confirm & Pay to place your order.</p>
    `;
  }

  if (method === "GCash Number Transfer") {
    box.innerHTML = `
      <h3>Send to GCash Number</h3>
      <p class="payment-number">${gcashNumber}</p>
      <p>After transfer, click Confirm & Pay to place your order.</p>
    `;
  }

  if (method === "Instapay Transfer") {
    box.innerHTML = `
      <h3>Instapay Transfer</h3>
      <img src="../images/instapay-qr.jpg" alt="Instapay QR Code" onerror="this.style.display='none'">
      <p>Use the same QR code for Instapay transfer.</p>
    `;
  }
}
    ...
    ordersList.innerHTML += `
      <div class="track-card">
        ...
        <div class="progress-line">
          ...
          <div class="track-step ${step1}"><span>${trackStepIcon(true)}</span><p>Order Placed</p></div>
          <div class="track-step ${step2}"><span>${trackStepIcon(true)}</span><p>Payment</p></div>
